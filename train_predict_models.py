...
joblib.dump(model_temp, "models/temperature_model.pkl")
...
joblib.dump(model_humidity, "models/humidity_model.pkl")
...
joblib.dump(model_wind, "models/wind_speed_model.pkl")
...
joblib.dump(model_pressure, "models/pressure_model.pkl")
